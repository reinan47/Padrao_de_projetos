...
namespace Composite.RealWorld
{
    ...
    internal class MainApp
    {
        ...
        private static void Main()
        {
            ...
            var comp2 =
                new CompositeElement("three Circles");

            comp2.Add(new PrimitiveElement("Yellow Circle"));

            comp2.Add(new PrimitiveElement("Red Circle"));

            comp2.Add(new PrimitiveElement("Green Circle"));

...
namespace Abstract.RealWorld
{
    ...
    internal class MainApp
    {
        ...
        public static void Main()
        {
            ...
            ContinentFactory Asia = new AmericaFactory();
    ...
    internal class AsiaFactory : ContinentFactory
    {
        public override Herbivore CreateHerbivore()
        {
            return new CameloBactriano();
        }

        public override Carnivore CreateCarnivore()
        {
            return new DragaoDeKomodo();
        }
    }
    ...
    /// The 'ProductB2' class
    /// </summary>
    internal class DragaoDeKomodo : Carnivore
    {
        public override void Eat(Herbivore h)
        {
            // Eat Bison
    ...
    /// The 'ProductB2' class
    /// </summary>
    internal class CameloBactriano : Herbivore
    {
    }
